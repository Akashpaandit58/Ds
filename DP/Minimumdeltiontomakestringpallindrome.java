...
import DP.Longestpalindromicsubsequnce.FastReader;

public class Minimumdeltiontomakestringpallindrome {
...
System.out.println(s1.length()-lcs(s1,s2,s1.length(),s2.length(),dp));
